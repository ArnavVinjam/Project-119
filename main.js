...
document.getElementById("last_p_tag").innerHTML = document.getElementById("last_p_tag").innerHTML + "Sketch to be drawn: " + sketch;
...
function gotResult(error, results){
    ...
    document.getElementById("p_tag").innerHTML = "Your Sketch: " + drawn_sketch;
    document.getElementById("other_p_tag").innerHTML = "Confidence: " + Math.round[0].confidence*100+'%'
}